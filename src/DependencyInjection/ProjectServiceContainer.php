...
class DonorEventStoreInterface_beb126f implements \ProxyManager\Proxy\VirtualProxyInterface, \byrokrat\giroapp\Db\DonorEventStoreInterface
{
     ...
     */
    private $valueHolder2f640 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer63c62 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesfe69a = [
        
    ];

    public function addDonorEventEntry(\byrokrat\giroapp\Db\DonorEventEntry $entry) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'addDonorEventEntry', array('entry' => $entry), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->addDonorEventEntry($entry);
return;
    }

    public function readEntriesForMandateKey(string $mandateKey) : iterable
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'readEntriesForMandateKey', array('mandateKey' => $mandateKey), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->readEntriesForMandateKey($mandateKey);
    }

    public function readAllEntries() : iterable
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'readAllEntries', array(), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->readAllEntries();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer63c62 = $initializer;
    ...
    public function __construct()
    {
        ...
        if (! $this->valueHolder2f640) {
            $reflection = $reflection ?? new \ReflectionClass('byrokrat\\giroapp\\Db\\DonorEventStoreInterface');
            $this->valueHolder2f640 = $reflection->newInstanceWithoutConstructor();
        }
    }

    public function & __get($name)
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, '__get', ['name' => $name], $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        if (isset(self::$publicPropertiesfe69a[$name])) {
            return $this->valueHolder2f640->$name;
        }

        $targetObject = $this->valueHolder2f640;
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, '__isset', array('name' => $name), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, '__unset', array('name' => $name), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;
...
return;
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, '__clone', array(), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640 = clone $this->valueHolder2f640;
    }

    public function __sleep()
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, '__sleep', array(), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return array('valueHolder2f640');
    }
    ...
    {
        $this->initializer63c62 = $initializer;
    }

    public function getProxyInitializer()
    {
        return $this->initializer63c62;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'initializeProxy', array(), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder2f640;
    }

    public function getWrappedValueHolderValue() : ?object
    {
        return $this->valueHolder2f640;
    }
...
class DonorQueryDecorator_48491f1 extends \byrokrat\giroapp\Db\DonorQueryDecorator implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'findAll', array(), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->findAll();
    }

    public function findByMandateKey(string $mandateKey) : ?\byrokrat\giroapp\Domain\Donor
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'findByMandateKey', array('mandateKey' => $mandateKey), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->findByMandateKey($mandateKey);
    }

    public function requireByMandateKey(string $mandateKey) : \byrokrat\giroapp\Domain\Donor
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'requireByMandateKey', array('mandateKey' => $mandateKey), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->requireByMandateKey($mandateKey);
    }

    public function findByPayerNumber(string $payerNumber) : ?\byrokrat\giroapp\Domain\Donor
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'findByPayerNumber', array('payerNumber' => $payerNumber), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->findByPayerNumber($payerNumber);
    }

    public function requireByPayerNumber(string $payerNumber) : \byrokrat\giroapp\Domain\Donor
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'requireByPayerNumber', array('payerNumber' => $payerNumber), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->requireByPayerNumber($payerNumber);
    }
    ...
    public function __construct(\byrokrat\giroapp\Db\DonorQueryInterface $decorated)
    {
        ...
        $this->valueHolder2f640->__construct($decorated);
    }
...
class DonorRepositoryInterface_13c774f implements \ProxyManager\Proxy\VirtualProxyInterface, \byrokrat\giroapp\Db\DonorRepositoryInterface
{
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'addNewDonor', array('newDonor' => $newDonor), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->addNewDonor($newDonor);
return;
    }

    public function deleteDonor(\byrokrat\giroapp\Domain\Donor $donor) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'deleteDonor', array('donor' => $donor), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->deleteDonor($donor);
return;
    }

    public function updateDonorName(\byrokrat\giroapp\Domain\Donor $donor, string $newName) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'updateDonorName', array('donor' => $donor, 'newName' => $newName), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->updateDonorName($donor, $newName);
return;
    }
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'updateDonorState', array('donor' => $donor, 'newState' => $newState), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->updateDonorState($donor, $newState);
return;
    }

    public function updateDonorPayerNumber(\byrokrat\giroapp\Domain\Donor $donor, string $newPayerNumber) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'updateDonorPayerNumber', array('donor' => $donor, 'newPayerNumber' => $newPayerNumber), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->updateDonorPayerNumber($donor, $newPayerNumber);
return;
    }

    public function updateDonorAmount(\byrokrat\giroapp\Domain\Donor $donor, \Money\Money $newAmount) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'updateDonorAmount', array('donor' => $donor, 'newAmount' => $newAmount), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->updateDonorAmount($donor, $newAmount);
return;
    }
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'updateDonorAddress', array('donor' => $donor, 'newAddress' => $newAddress), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->updateDonorAddress($donor, $newAddress);
return;
    }

    public function updateDonorEmail(\byrokrat\giroapp\Domain\Donor $donor, string $newEmail) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'updateDonorEmail', array('donor' => $donor, 'newEmail' => $newEmail), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->updateDonorEmail($donor, $newEmail);
return;
    }

    public function updateDonorPhone(\byrokrat\giroapp\Domain\Donor $donor, string $newPhone) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'updateDonorPhone', array('donor' => $donor, 'newPhone' => $newPhone), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->updateDonorPhone($donor, $newPhone);
return;
    }

    public function updateDonorComment(\byrokrat\giroapp\Domain\Donor $donor, string $newComment) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'updateDonorComment', array('donor' => $donor, 'newComment' => $newComment), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->updateDonorComment($donor, $newComment);
return;
    }

    public function setDonorAttribute(\byrokrat\giroapp\Domain\Donor $donor, string $key, string $value) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'setDonorAttribute', array('donor' => $donor, 'key' => $key, 'value' => $value), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->setDonorAttribute($donor, $key, $value);
return;
    }

    public function deleteDonorAttribute(\byrokrat\giroapp\Domain\Donor $donor, string $key) : void
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'deleteDonorAttribute', array('donor' => $donor, 'key' => $key), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->deleteDonorAttribute($donor, $key);
return;
    }
...
class DriverInterface_5855917 implements \ProxyManager\Proxy\VirtualProxyInterface, \byrokrat\giroapp\Db\DriverInterface
{
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'getDonorEventStore', array('environment' => $environment), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->getDonorEventStore($environment);
    }
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'getDonorRepository', array('environment' => $environment), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->getDonorRepository($environment);
    }
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'getImportHistory', array('environment' => $environment), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->getImportHistory($environment);
    }

    public function commit() : bool
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'commit', array(), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->commit();
    }

    public function rollback() : bool
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'rollback', array(), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->rollback();
    }
...
class ImportHistoryInterface_32011a6 implements \ProxyManager\Proxy\VirtualProxyInterface, \byrokrat\giroapp\Db\ImportHistoryInterface
{
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'addToImportHistory', array('file' => $file), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        $this->valueHolder2f640->addToImportHistory($file);
return;
    }
    ...
    {
        $this->initializer63c62 && ($this->initializer63c62->__invoke($valueHolder2f640, $this, 'fileWasImported', array('file' => $file), $this->initializer63c62) || 1) && $this->valueHolder2f640 = $valueHolder2f640;

        return $this->valueHolder2f640->fileWasImported($file);
    }
