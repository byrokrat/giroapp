...
use byrokrat\giroapp\Domain\State\AwaitingPayerNumberChangeTransactionUpdate;
...
class AwaitingPayerNumberChangeTransactionUpdateSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(AwaitingPayerNumberChangeTransactionUpdate::class);
    }
    ...
    {
        $this->getStateId()->shouldEqual('AWAITING_PAYER_NUMBER_CHANGE_TRANSACTION_UPDATE');
    }
