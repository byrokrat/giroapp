...
use byrokrat\giroapp\Xml\NullXmlMandateMigration;
use byrokrat\giroapp\Xml\XmlMandateMigrationInterface;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

class NullXmlMandateMigrationSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(NullXmlMandateMigration::CLASS);
    }
