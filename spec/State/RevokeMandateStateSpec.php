...
class RevokeMandateStateSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(State\RevokeMandateState::CLASS);
    }
    ...
    {
        $this->getId()->shouldEqual(State\RevokeMandateState::CLASS);
    }
    ...
    function it_is_exportable_to_autogiro(Donor $donor, Writer $writer)
    {
        ...
        $donor->setState(Argument::type(State\RevocationSentState::CLASS))->shouldHaveBeenCalled();
    }
}
